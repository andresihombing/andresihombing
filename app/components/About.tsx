        ...
        <div className="flex flex-col lg:flex-row items-start gap-16">
          ...
          >
            ...
            <div className="space-y-6 text-gray-600 dark:text-gray-300">
              <p>
                Hi! I&apos;m Andre Sihombing, a Frontend Developer with 4 years of experience with strong problem-solving skills and
                 I love learning new technologies related to software development and enjoy working in a team.
              </p>
              
              <p>
                Based in Jakarta, I have had the opportunity to work with clients ranging from startups to established companies. 
                My expertise lies in building scalable web or mobile applications that combine functionality with great user experience.
              </p>

              <p>
                If you want to discuss with me, feel free to contact me.
              </p>
            </div>
            ...
            <div className="mt-12">
              ...
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  'TailwindCSS', 'Angular', 'Laravel', 'Yii2', 'PHP'
                ].map((skill) => (
                  <motion.span 
                    key={skill}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mt-12">
              {[
                { number: '4+', label: 'Years', color: 'from-purple-600 to-indigo-600' },
