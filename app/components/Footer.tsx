...
const socialLinks = [
  {
    name: "GitHub",
    url: "https://github.com/andresihombing",
    icon: (
  ...
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/andre-sihombing/",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 py-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 max-w-sm">
              I am a software developer with strong problem solving skills and I really like learning new technologies related to software development and love to work in teams.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              {/* WhatsApp */}
              <p className="flex items-center gap-3 text-gray-400">
                <a href="https://wa.me/6285928864477" target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-3 hover:text-green-500 transition-colors">
                  <svg className="w-5 h-5 text-green-400" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd"
                      d="M16.6 14c-.2-.1-1.5-.7-1.7-.8c-.2-.1-.4-.1-.6.1c-.2.2-.6.8-.8 1c-.1.2-.3.2-.5.1c-.7-.3-1.4-.7-2-1.2c-.5-.5-1-1.1-1.4-1.7c-.1-.2 0-.4.1-.5c.1-.1.2-.3.4-.4c.1-.1.2-.3.2-.4c.1-.1.1-.3 0-.4c-.1-.1-.6-1.3-.8-1.8c-.1-.7-.3-.7-.5-.7h-.5c-.2 0-.5.2-.6.3c-.6.6-.9 1.3-.9 2.1c.1.9.4 1.8 1 2.6c1.1 1.6 2.5 2.9 4.2 3.7c.5.2.9.4 1.4.5c.5.2 1 .2 1.6.1c.7-.1 1.3-.6 1.7-1.2c.2-.4.2-.8.1-1.2l-.4-.2M18.2 4C15.2 1 8.9 1 5 4.9c-3.2 3.2-3.8 8.1-1.6 12L2 22l5.3-1.4c1.5.8 3.1 1.2 4.7 1.2c5.5 0 9.9-4.4 9.9-9.9c.1-2.6-1-5.1-2.8-7z"/>
                  </svg>
                  0859-2886-4477
                </a>
              </p>
        ...
        <div className="border-t border-gray-800 py-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-gray-300 text-sm">
              © {new Date().getFullYear()} Andre Sihombing. All rights reserved.
            </p>
          </div>
        </div>
      </div>
